      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <input
            ...
            placeholder="••••••••"
            className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 pr-10 text-sm text-white placeholder-slate-500 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
          />
        ...
        <p className="text-[10px] text-slate-500 leading-tight px-1 mt-0.5">
